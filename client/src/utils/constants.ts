...
export const NPCS = [
  // Buena Village NPCs
  {
    ...
    area: 'buena-village',
    dialogue: ['Hello traveler!', 'Rudeus is around here somewhere...', 'Be careful out there!'],
    type: 'villager',
  },
  {
    id: 'paul',
    ...
    area: 'buena-village',
    dialogue: ['Training is important!', 'Have you seen my son Rudeus?'],
    type: 'villager',
  },
  {
    id: 'lilia',
    ...
    area: 'buena-village',
    dialogue: ['Welcome to Buena Village!', 'The well is in the center.'],
    type: 'villager',
  },
  {
    id: 'buena-shopkeeper',
    ...
    position: { x: -12, y: 0, z: 8 },
    area: 'buena-village',
    dialogue: ['Buy something!', 'Potions, weapons, armor!'],
    type: 'shopkeeper',
  },
  // Asura Kingdom NPCs
  {
    ...
    area: 'asura-kingdom',
    dialogue: ['Halt! State your business.', 'The King is not receiving visitors.'],
    type: 'guard',
  },
  {
    id: 'asura-noble',
    ...
    position: { x: 0, y: 0, z: 10 },
    area: 'asura-kingdom',
    dialogue: ['Welcome to Asura Kingdom.', 'The finest magic in the land!'],
    type: 'villager',
  },
  {
    id: 'training-master',
    ...
    area: 'asura-kingdom',
    dialogue: ['Train hard!', 'Only the strong survive!'],
    type: 'villager',
  },
  // Magic City Sharia NPCs
  {
    ...
    dialogue: ['Learn the ways of magic!', 'Practice makes perfect.'],
    type: 'villager',
  },
  {
    id: 'guild-master',
    ...
    area: 'magic-city-sharia',
    dialogue: ['Need a job?', 'We have quests for brave adventurers!'],
    type: 'quest-giver',
  ...
  },
  {
    ...
    area: 'magic-city-sharia',
    dialogue: ['Shhh... be quiet!', 'Knowledge is power.'],
    type: 'villager',
  },
  {
    id: 'merchant',
    ...
    position: { x: 0, y: 0, z: 35 },
    area: 'magic-city-sharia',
    dialogue: ['Rare magical items for sale!', 'Come back often!'],
    type: 'shopkeeper',
  },
];
...
export const MONSTERS = [
  ...
  // Magic City Sharia area monsters
  {
    id: 'demon-1',
    name: 'Lesser Demon',
    type: 'demon',
...
export const QUEST_MARKERS = [
  ...
  },
  {
    ...
    type: 'side',
    completed: false,
    questId: 'defeat-goblins',
  },
  {
    id: 'buena-quest-3',
    name: 'Explore Village',
    position: { x: 0, y: 0, z: 10 },
    area: 'buena-village',
    type: 'side',
    completed: false,
    questId: 'explore-village',
  },
  // Asura Kingdom quests
  {
    ...
    type: 'main',
    completed: false,
    questId: 'meet-the-king',
  },
  {
    id: 'asura-quest-2',
    name: 'Defeat Skeleton Warriors',
    position: { x: 40, y: 0, z: 10 },
    area: 'asura-kingdom',
    type: 'side',
    completed: false,
    questId: 'defeat-skeletons',
  },
  {
    id: 'asura-quest-3',
    name: 'Train at Grounds',
    position: { x: 0, y: 0, z: -40 },
    area: 'asura-kingdom',
    type: 'side',
    completed: false,
    questId: 'train-at-grounds',
  },
  ...
  },
  {
    ...
    type: 'side',
    completed: false,
    questId: 'defeat-demons',
  },
  {
    id: 'magic-quest-3',
    name: 'Visit the Tower',
    position: { x: 0, y: 0, z: -60 },
    area: 'magic-city-sharia',
    type: 'side',
    completed: false,
    questId: 'visit-the-tower',
  },
];
