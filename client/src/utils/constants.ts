...
export const SKILLS: Record<string, Skill> = {
  ...
  'fireball': { id: 'fireball', name: 'Fireball', description: 'Launches a ball of fire', type: 'attack', damage: 40, manaCost: 25, cooldown: 3000, range: 15 },
  'ice-shield': { id: 'ice-shield', name: 'Ice Shield', description: 'Creates a protective barrier', type: 'defense', manaCost: 20, cooldown: 8000, range: 1 },
  'teleport': { id: 'teleport', name: 'Teleport', description: 'Instantly move to a location', type: 'utility', manaCost: 30, cooldown: 15000, range: 20 },
  ...
  'stealth': { id: 'stealth', name: 'Stealth', description: 'Become invisible', type: 'utility', manaCost: 15, cooldown: 12000, range: 1 },
  ...
  'arrow-rain': { id: 'arrow-rain', name: 'Arrow Rain', description: 'Fires multiple arrows', type: 'attack', damage: 20, manaCost: 25, cooldown: 4000, range: 20 },
  'snipe': { id: 'snipe', name: 'Snipe', description: 'A precise long-range shot', type: 'attack', damage: 60, manaCost: 35, cooldown: 8000, range: 30 },
  'trap': { id: 'trap', name: 'Trap', description: 'Places a damaging trap', type: 'utility', manaCost: 20, cooldown: 10000, range: 5 },
  'heal': { id: 'heal', name: 'Heal', description: 'Restores health', type: 'heal', healAmount: 40, manaCost: 25, cooldown: 3000, range: 10 },
  'revive': { id: 'revive', name: 'Revive', description: 'Brings a fallen ally back', type: 'heal', healAmount: 100, manaCost: 50, cooldown: 30000, range: 5 },
  'bless': { id: 'bless', name: 'Bless', description: 'Increases ally stats', type: 'utility', manaCost: 30, cooldown: 15000, range: 10 },
};
